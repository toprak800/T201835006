...
public class Suggestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Suggesiton and Opinon");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try
       {
           ...
           String sql = "insert into suggestion (Suggestion) Values(?)";
           PreparedStatement pstmt = conn.prepareStatement(sql);
           pstmt.setString(1,jTextArea1.getText());
           
           JOptionPane.showMessageDialog(null,"Thanks for your Suggestion and Opinion.");
